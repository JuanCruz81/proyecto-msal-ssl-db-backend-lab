...
var AccountEntity = (
  ...
  function() {
    ...
    AccountEntity2.createAccount = function(accountDetails, authority) {
    ...
    AccountEntity2.createFromAccountInfo = function(accountInfo, cloudGraphHostName, msGraphHost) {
      var account = new AccountEntity2();
    ...
    AccountEntity2.generateHomeAccountId = function(serverClientInfo, authType, logger, cryptoObj, idTokenClaims) {
...
function buildClientConfiguration(_a) {
  ...
  return {
    ...
    loggerOptions,
    cacheOptions: __assign2(__assign2({}, DEFAULT_CACHE_OPTIONS), userCacheOptions),
...
var BrowserCacheManager = (
  ...
  function(_super) {
    ...
    BrowserCacheManager2.prototype.clearTokensAndKeysWithClaims = function() {
      return __awaiter(this, void 0, void 0, function() {
    ...
    BrowserCacheManager2.prototype.hydrateCache = function(result, request) {
      var _a, _b, _c, _d, _e, _f;
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_g) {
          switch (_g.label) {
            case 0:
              ...
              if (!request.claims)
                return [3, 2];
              return [4, this.cryptoImpl.hashString(request.claims)];
            case 1:
              claimsHash = _g.sent();
              _g.label = 2;
            case 2:
              accessTokenEntity = AccessTokenEntity.createAccessTokenEntity(
                ...
                ((_d = result.account) === null || _d === void 0 ? void 0 : _d.environment) || "",
                result.accessToken,
                this.clientId,
                result.tenantId,
                result.scopes.join(" "),
                ((_e = result.expiresOn) === null || _e === void 0 ? void 0 : _e.getTime()) || 0,
                ((_f = result.extExpiresOn) === null || _f === void 0 ? void 0 : _f.getTime()) || 0,
                this.cryptoImpl,
                void 0,
                // refreshOn
                result.tokenType,
              ...
              cacheRecord = new CacheRecord(void 0, idTokenEntity, accessTokenEntity);
              return [2, this.saveCacheRecord(cacheRecord)];
          }
        });
      });
    };
...
var NativeInteractionClient = (
  ...
  function(_super) {
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            ...
            case 2:
              ...
              return [2, __assign(__assign({}, result), { account: fullAccount })];
            case 3:
              e_2 = _a.sent();
              throw e_2;
            case 4:
    ...
    NativeInteractionClient2.prototype.cacheNativeTokens = function(response, request, homeAccountIdentifier, idTokenObj, responseAccessToken, tenantId, reqTimestamp) {
      ...
      var nativeCacheRecord = new CacheRecord(void 0, cachedIdToken, cachedAccessToken);
...
function buildConfiguration(_a, isBrowserEnvironment) {
  ...
  var overlayedConfig = {
    ...
    cache: __assign(__assign({}, DEFAULT_CACHE_OPTIONS2), userInputCache),
...
var TokenCache = (
  ...
  function() {
    ...
    TokenCache2.prototype.loadAccount = function(idToken, authority, clientInfo, requestHomeAccountId) {
      var homeAccountId;
      ...
      var accountEntity = AccountEntity.createAccount({ homeAccountId, idTokenClaims: idToken.claims, clientInfo, environment: authority.hostnameAndPort }, authority);
    ...
    TokenCache2.prototype.generateAuthenticationResult = function(request, idTokenObj, cacheRecord, accountEntity, authority) {
      var _a;
        ...
        return __generator(this, function(_b) {
          switch (_b.label) {
            ...
            case 4:
              ...
              return [4, this.browserStorage.clearTokensAndKeysWithClaims()];
            case 5:
              _b.sent();
...
var PublicClientApplication = (
  ...
  function(_super) {
    ...
    PublicClientApplication2.prototype.hydrateCache = function(result, request) {
      return __awaiter(this, void 0, void 0, function() {
        var accountEntity;
        return __generator(this, function(_a) {
          ...
          if (result.account) {
            ...
            if (result.fromNativeBroker) {
              ...
              return [2, this.nativeInternalStorage.hydrateCache(result, request)];
            } else {
              return [2, this.browserStorage.hydrateCache(result, request)];
            }
          }
          return [
            2
...
@azure/msal-browser/dist/index.js:
  (*! @azure/msal-browser v2.39.0 2024-06-06 *)
*/
//# sourceMappingURL=chunk-32ZAQ2YV.js.map
