declare module 'adaptivecards/strings' {
    ...
    static readonly errors: {
        ...
        tooLittleTimeDelay: (minAutoplayDelay: number) => string;
        tooManyCarouselPages: (maxCarouselPages: number) => string;
        invalidInitialPageIndex: (initialPageIndex: number) => string;
    ...
    static readonly defaults: {
        ...
        emptyElementText: (elementType: string) => string;
        mediaPlayerAriaLabel: () => string;
        mediaPlayerPlayMedia: () => string;
        youTubeVideoPlayer: () => string;
        vimeoVideoPlayer: () => string;
        dailymotionVideoPlayer: () => string;
        carouselNavigationPreviousTooltip: () => string;
        carouselNavigationNextTooltip: () => string;
    };
}
...
export function truncateText(element: HTMLElement, maxHeight: number, lineHeight?: number): void;
...
export function addCancelSelectActionEventHandler(element: HTMLElement): void;
...
export abstract class BaseSerializationContext {
    ...
    private tryDeleteValue;
    private tryDeleteDefaultValue;
...
export function property(prop: PropertyDefinition): (target: any, propertyKey: string) => void;
...
export abstract class SerializableObject {
    ...
    protected setValue(prop: PropertyDefinition, value: any): void;
...
export class InputConfig {
    ...
    readonly debounceTimeInMilliSeconds: number;
    readonly allowDynamicallyFilteredChoiceSet: boolean;
    readonly allowRevealOnHoverStyle: boolean;
    constructor(obj?: any);
}
...
declare module 'adaptivecards/carousel' {
	import { ActionType, CardElement, Container, SerializationContext } from 'adaptivecards/card-elements';
import * as Enums from 'adaptivecards/enums';
import { BoolProperty, NumProperty, EnumProperty, PropertyBag, SerializableObjectSchema, PixelSizeProperty } from 'adaptivecards/serialization';
...
declare module 'adaptivecards/card-elements' {
	import * as Enums from 'adaptivecards/enums';
import { CarouselEvent } from 'adaptivecards/carousel';
...
export abstract class Input extends CardElement implements IInput {
    ...
    protected get allowRevealOnHoverStyle(): boolean;
    protected shouldHideInputAdornersForRevealOnHover(input: HTMLElement, eventType: InputEventType): boolean;
...
export class ChoiceSetInputDataQuery extends SerializableObject {
    ...
    static readonly datasetProperty: StringProperty;
    static readonly countProperty: NumProperty;
    static readonly skipProperty: NumProperty;
    type: string;
    dataset: string;
    count?: number;
    skip?: number;
...
export class ChoiceSetInput extends Input {
    ...
    static readonly choicesDataProperty: SerializableObjectProperty;
    static readonly styleProperty: ValueSetProperty;
    ...
    private _labels;
    private _filteredChoiceSet?;
    isDynamicTypeahead(): boolean;
    getFilterForDynamicSearch(): string | undefined;
    getDropdownElement(): HTMLDivElement | undefined;
    renderChoices(filter: string, fetchedChoices: FetchedChoice[]): void;
    showLoadingIndicator(): void;
    removeLoadingIndicator(): void;
    showErrorIndicator(filter: string, error: string): void;
    showValidationFailureCue(): void;
    removeValidationFailureCue(): void;
...
export class FilteredChoiceSet {
    private _parent?;
    private _choiceSetId;
    private _choices;
    private _dynamicChoices;
    private _visibleChoiceCount;
    private _highlightedChoiceId;
    private _textInput?;
    private _dropdown?;
    ...
    processChoices(): void;
    processResponse(filter: string, fetchedChoices: FetchedChoice[]): void;
    showLoadingIndicator(): void;
    removeLoadingIndicator(): void;
    showErrorIndicator(filter: string, error: string): void;
    get dynamicChoices(): string[];
    get hostConfig(): HostConfig;
    set parent(value: CardObject | undefined);
    get parent(): CardObject | undefined;
    get renderedElement(): HTMLElement | undefined;
    get textInput(): HTMLInputElement | undefined;
    get dropdown(): HTMLDivElement | undefined;
}
...
export abstract class Action extends CardObject {
    ...
    static readonly roleProperty: EnumProperty<typeof Enums.ActionRole>;
    title?: string;
    iconUrl?: string;
    style: string;
    mode: string;
...
export class DataQuery extends UniversalAction {
    static readonly JsonTypeName: "Data.Query";
    static readonly datasetProperty: StringProperty;
    static readonly filterProperty: StringProperty;
    static readonly countProperty: NumProperty;
    static readonly skipProperty: NumProperty;
    dataset: string;
    filter: string;
...
declare module 'adaptivecards/activity-request' {
	import { Authentication, AuthCardButton, UniversalAction, TokenExchangeResource } from 'adaptivecards/card-elements';
...
export class LoginRequestResponse extends ActivityResponse {
    ...
    constructor(request: IActivityRequest, auth: Authentication);
...
import { SerializationContext, AdaptiveCard, Action, TokenExchangeResource, AuthCardButton, UniversalAction } from 'adaptivecards/card-elements';
import { HostConfig } from 'adaptivecards/host-config';
export class AdaptiveApplet {
    private static readonly _submitMagicCodeActionId;
    private static readonly _cancelMagicCodeAuthActionId;
    private _card?;
    ...
    private internalSendExecuteRequestAsync;
    private internalSendDataQueryRequestAsync;
...
declare module 'adaptivecards/schema' {
	import { ImageSetPresentationStyle } from 'adaptivecards/enums';
...
export * from 'adaptivecards/carousel';
